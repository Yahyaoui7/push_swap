...
INC = push_swap.h operations/operations.h parsing/parsing.h stack/stack.h sorting/sorting.h

SRC_MAIN    = push_swap.c

SRC_PARSING = parsing/parser.c parsing/ft_checks.c parsing/parsing_helpers.c parsing/ft_splite.c
